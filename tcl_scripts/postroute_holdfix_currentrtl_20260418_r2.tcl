set checkpoint "/home/fy2243/soc_design/pd/holdfix_currentrtl_20260418/with_sram_holdfix.enc.dat"
set design     "soc_top"
set out_root   "/home/fy2243/soc_design/pd/holdfix_currentrtl_20260418_r2"
set sta_root   "/home/fy2243/soc_design/sta/currentrtl_20260418_holdfix_r2/innovus"
set view       "view_typ"
...
setOptMode -holdTargetSlack 0.150
...
saveDesign [file join $out_root with_sram_holdfix_r2.enc]
saveNetlist [file join $sta_root ${design}_postroute_holdfix_r2.v]
rcOut -spef [file join $sta_root ${design}_postroute_holdfix_r2.spef] -view $view -cUnit pF
write_sdf [file join $sta_root ${design}_postroute_holdfix_r2.sdf] -view $view -recompute_delay_calc -precision 4
...
puts $fp "checkpoint_out=[file join $out_root with_sram_holdfix_r2.enc]"
