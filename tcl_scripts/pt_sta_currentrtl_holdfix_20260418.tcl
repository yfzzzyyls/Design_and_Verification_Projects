set out_dir   "/home/fy2243/soc_design/sta/currentrtl_20260418_holdfix/primetime"
set in_dir    "/home/fy2243/soc_design/sta/currentrtl_20260418_holdfix/innovus"
set design    "soc_top"
...
read_verilog [file join $in_dir ${design}_postroute_holdfix.v]
...
read_parasitics [file join $in_dir ${design}_postroute_holdfix.spef]
update_timing
